# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-12-27 10:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transfer_enable', models.BigIntegerField(db_column='transfer_enable', default=0, verbose_name='总流量')),
                ...
                ('method', models.CharField(choices=[('aes-256-cfb', 'aes-256-cfb'), ('aes-128-ctr', 'aes-128-ctr'), ('rc4-md5', 'rc4-md5'), ('salsa20', 'salsa20'), ('chacha20', 'chacha20'), ('none', 'none')], default='rc4-md5', max_length=32, verbose_name='加密类型')),
